...
Info v[37] = {
Info(5122409037LL, string("NHB Lolicon")),
Info(5122409038LL, string("LWH Sag")),
Info(5122409039LL, string("LYP Monster")),
Info(5120309059LL, string("SQY NoneHead")),
Info(5130309008LL, string("ZYD JUDA")),
Info(5130309015LL, string("HYC Talent")),
Info(5130309016LL, string("HYY Yellow")),
Info(5130309017LL, string("MHJ Rich")),
Info(5130309019LL, string("W_X Guitar")),
Info(5130309021LL, string("YSQ Librarian")),
Info(5130309022LL, string("ZJR Sister")),
Info(5130309023LL, string("ZXH Xihu")),
Info(5130309026LL, string("BJW Gay")),
Info(5130309028LL, string("SJR Boccchan")),
Info(5130309030LL, string("W F Extraordinary")),
Info(5130309031LL, string("WLL Lili")),
Info(5130309032LL, string("W_C Sick")),
Info(5130309033LL, string("W_J 1/3Silly")),
Info(5130309045LL, string("BZH Mathematics")),
Info(5130309052LL, string("LJH Touhou")),
Info(5130309056LL, string("XYF Server")),
Info(5130309058LL, string("C_D 0CD")),
Info(5130309059LL, string("LJJ TopRich")),
Info(5130309062LL, string("G_Y TA1")),
Info(5130309066LL, string("CXY Goddess")),
Info(5130309067LL, string("J_Y Ji")),
Info(5130309070LL, string("SHY Thanatos")),
Info(5130309305LL, string("CZH OzoraTsubasa")),
Info(5130379062LL, string("SSW Participants")),
Info(5130379096LL, string("YJT Physical")),
Info(5130719033LL, string("LYW Ln")),
Info(5132029007LL, string("CJL Literal")),
Info(5132409031LL, string("ZYY Medvedev")),
Info(5132409032LL, string("GJF Data From")),
Info(5132409033LL, string("W_T Onisan")),
Info(5132409034LL, string("ZYL BirdBear")),
Info(5134139006LL, string("X_C Traffic Accident"))};
...
void testHash()
{
    ...
    printHash(hash1);
    cout << hash1.get(v[0].id) << '\n' << hash1.get(v[33].id) << endl;
    try
    {
...
void testTree()
{
    ...
    printTree(tree1);
    cout << tree1.get(v[0].id) << '\n' << tree1.get(v[33].id) << endl;
    try
    {
